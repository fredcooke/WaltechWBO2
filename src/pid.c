...
// Set up PID controller parameters: fills the structure PID_DATA.
{
...
// Calculate P+I+D
/////NOTE://adjusted time here by dividig I by the frequency of pid calculations
  ret = (p_term + (i_term/30) + (d_term)) / SCALING_FACTOR;
  if(ret > MAX_INT){
    ret = MAX_INT;
  }
 // else if(ret < 0){
